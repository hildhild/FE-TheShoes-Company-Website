...
<body>
    <div id="main">
        ...
        <div class="lg:px-[220px] md:px-[80px] px-[20px] py-[50px] mt-[65px]">
            ...
            <form action="">
                <div class="flex flex-col md:flex-row mt-[20px] gap-5 border-b border-b-black">
                    <div class="w-full md:w-1/3">
                        <p class="text-2xl font-semibold">Account information</p>
                    </div>
                ...
                <div class="flex flex-col md:flex-row mt-[20px] gap-5 border-b border-b-black">
                    <div class="w-full md:w-1/3">
                        <p class="text-2xl font-semibold">Payment method</p>
                    </div>
                    <div class="w-full md:w-2/3">
                        <div>
