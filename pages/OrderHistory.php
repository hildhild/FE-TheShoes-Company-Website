...
<body>
    <div id="main">
        ...
        <div class="header flex justify-between lg:px-[60px] px-[34px] bg-[#f2f2f2] fixed top-[30px] left-0 right-0 z-50">
            ...
            <div class="header__navbar flex items-center order-1 lg:order-2 lg:mr-auto lg:ml-[62px]">
                ...
                <div class="header__navbar-container custom-hidden flex flex-col absolute top-[65px] left-0 right-0 items-start lg:static lg:flex-row lg:items-center bg-white lg:bg-[#f2f2f2]">
                    ...
                    <div class="header__navbar-item w-full"><a href="#" class="md:px-[25px] px-[18px] lg:py-[16.5px] py-[10px] block w-full text-xl font-semibold lg:text-2xl">History</a>
                    </div>
        ...
        <div class="lg:px-[80px] px-[42px] lg:py-[40px] md:py-[28px] py-[24px] mt-[95px]">
            <h2 class="text-[36px] font-semibold">Orders History</h2>
            <div class="relative mt-[20px]">
                <form action="">
                    <input type="text" id="search-order" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 pl-2.5 pr-12" placeholder="Search Order..." required>
                    <button type="submit" class="px-2 py-1 absolute right-[10px] bottom-1/2 translate-y-1/2">
                        <i class="fa-solid fa-magnifying-glass"></i></button>
                </form>
            </div>
            <div class="flex flex-col md:flex-row gap-4 mt-[20px]">
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px] gap-[10px]">
                    <p class="text-sm font-semibold">Total Orders</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px] gap-[10px]">
                    <p class="text-sm font-semibold">Shipping Orders</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px] gap-[10px]">
                    <p class="text-sm font-semibold">Rejected Orders</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px] gap-[10px]">
                    <p class="text-sm font-semibold">Ordered Orders</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
            </div>
            <div class="overflow-x-scroll md:overflow-hidden">
                <div class="mt-[20px] w-[684px] md:w-auto">
                    <div class="flex flex-row text-base font-semibold text-[#8F9BB3] bg-[#EFF4FA] p-[20px] rounded-lg">
                        <div class="min-w-[20%]">Order ID</div>
                        <div class="min-w-[20%]">Created At</div>
                        <div class="min-w-[20%]">Total Price</div>
                        <div class="min-w-[20%]">Status</div>
                        <div class="min-w-[20%]">Action</div>
                    </div>
                    <div class="flex flex-row text-base text-black bg-white p-[20px] border border-[#d1d1d1] rounded-lg mt-2.5 items-center">
                        <div class="min-w-[20%]">LA-0234</div>
                        <div class="min-w-[20%]">21 Aug, 2019</div>
                        <div class="min-w-[20%]">$99.99</div>
        ...
        <div class="footer bg-[#f2f2f2]">
            <div class="flex flex-row flex-wrap lg:flex-nowrap lg:py-[24px] lg:px-[193px] md:px-[200px] items-start lg:gap-[82px]  px-[50px] py-[50px]">
                ...
                <div class="md:w-full mt-[45px] md:mt-[60px] lg:mt-0">
                    ...
                    <div class="py-1">
                        <form action="">
                            <input type="text" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs">
