    ...
    <div id="main">
        ...
        <div class="lg:px-[100px] px-[20px] py-[50px] mt-[95px]">
            <div class="flex flex-row items-center justify-start gap-[10px]">
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 focus:outline-none">Edit
                </button>
                <button type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base px-5 py-2.5">Delete
                </button>
            ...
            <div class="flex flex-col">
                ...
                <div class="w-full items-center justify-center text-center py-2 product__slider-change mt-[22px]">
                    <div class="inline-block mr-[70px]"><i class="fa-solid fa-chevron-left product__slider-prev cursor-pointer"></i>
                    </div>
                    <div class="inline-block w-[15px] h-[15px] border border-black px-[5px] mx-[5px] product__slider-btn cursor-pointer active">
                    </div>
                    <div class="inline-block w-[15px] h-[15px] border border-black px-[5px] mx-[5px] product__slider-btn cursor-pointer">
                    </div>
                    <div class="inline-block w-[15px] h-[15px] border border-black px-[5px] mx-[5px] product__slider-btn cursor-pointer">
                    </div>
                    <div class="inline-block w-[15px] h-[15px] border border-black px-[5px] mx-[5px] product__slider-btn cursor-pointer">
                    </div>
                    <div class="inline-block ml-[70px]"><i class="fa-solid fa-chevron-right product__slider-next cursor-pointer"></i></div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row justify-between self-center mt-[20px]">
                <div class="flex flex-col gap-[10px]" contenteditable="true">
                    ...
                    <div class="flex flex-row flex-wrap text-base gap-[10px]">
                        <div class="h-[32px] w-[48px] bg-[#d9d9d9] flex justify-center items-center cursor-pointer hover:bg-[#a9a9a9]">
                            7</div>
                        <div class="h-[32px] w-[48px] bg-[#d9d9d9] flex justify-center items-center cursor-pointer hover:bg-[#a9a9a9]">
                            7.5</div>
                        <div class="h-[32px] w-[48px] bg-[#d9d9d9] flex justify-center items-center cursor-pointer hover:bg-[#a9a9a9]">
                    ...
                    <div class="flex flex-row text-base gap-[10px]">
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mt-2.5 focus:outline-none">Small
                        </button>
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mt-2.5 focus:outline-none">Medium
                        </button>
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mt-2.5 focus:outline-none">Large
                        </button>
                    </div>
                </div>
                <div class="mt-[32px] md:mt-0">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mt-2.5 focus:outline-none md:min-w-[180px]">Add
                        to cart
                        <i class="fa-solid fa-arrow-right inline-block ml-[30px]"></i>
                    </button>
                </div>
            </div>
            <div class="flex flex-col md:flex-row md:px-[84px] py-[12px] items-start md:items-center justify-between lg:mt-[90px] md:mt-[44px] mt-[24px] gap-[20px] text-base font-semibold border-t border-b border-black">
