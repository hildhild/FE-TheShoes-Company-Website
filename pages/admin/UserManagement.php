...
<body>
    <div id="main">
        <div
            class="sign flex flex-row h-[30px] fixed top-0 left-0 right-0 z-50 items-center md:px-[20px] px-[10px] justify-between bg-[#f2f2f2] text-sm">
        ...
        <div
            class="header flex justify-between lg:px-[60px] px-[34px] bg-[#f2f2f2] fixed top-[30px] left-0 right-0 z-50">
        ...
        <div class="lg:px-[80px] px-[42px] lg:py-[40px] md:py-[28px] py-[24px] mt-[95px]">
            <h2 class="text-[36px] font-semibold">User Management</h2>
            ...
            <div class="flex flex-col md:flex-row gap-4 mt-[20px]">
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px]">
                    <p class="text-sm font-semibold">Total Users</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px]">
                    <p class="text-sm font-semibold">Online Users</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px]">
                    <p class="text-sm font-semibold">Ban Users</p>
                    <p class="text-xl font-semibold">614</p>
                </div>
                <div class="w-full md:w-1/4 rounded-xl bg-[#f2f2f2] flex flex-col justify-between p-[20px]">
            ...
            <div class="overflow-x-scroll md:overflow-hidden">
                <div class="mt-[20px] w-[684px] md:w-auto">
                    <div class="flex flex-row text-base font-semibold text-[#8F9BB3] bg-[#EFF4FA] p-[20px] rounded-lg">
                        <div class="min-w-[20%]">Name</div>
                        <div class="min-w-[15%]">User ID</div>
                        <div class="min-w-[15%]">Username</div>
                        <div class="min-w-[20%]">Date</div>
                        <div class="min-w-[15%]">Role</div>
                        <div class="min-w-[15%]">Action</div>
                    </div>
                    <div
                        class="flex flex-row text-base text-black bg-white p-[20px] border border-[#d1d1d1] rounded-lg mt-2.5">
                        <div class="min-w-[20%]">Victoria Perez</div>
                        <div class="min-w-[15%]">LA-0234</div>
                        <div class="min-w-[15%]">perez_1502</div>
                        <div class="min-w-[20%]">21 Aug, 2019</div>
                        <div class="min-w-[15%]">Admin</div>
                        <div class="min-w-[15%] flex flex-row justify-start items-center text-xl gap-4">
