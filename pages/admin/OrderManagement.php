...
<body>
    <div id="main">
        ...
        <div class="lg:px-[80px] px-[42px] lg:py-[40px] md:py-[28px] py-[24px] mt-[95px]">
            <h2 class="text-[36px] font-semibold">Orders Management</h2>
            ...
            <div class="overflow-x-scroll lg:overflow-hidden">
                <div class="mt-[20px] min-w-[900px] lg:w-auto">
                    <div class="flex flex-row text-base font-semibold text-[#8F9BB3] bg-[#EFF4FA] p-[20px] rounded-lg">
                        <div class="min-w-[15%]">Order ID</div>
                        <div class="min-w-[17%]">Name</div>
                        <div class="min-w-[13%]">User ID</div>
                        <div class="min-w-[15%]">Created At</div>
                        <div class="min-w-[15%]">Total Price</div>
                        <div class="min-w-[15%]">Status</div>
                        <div class="min-w-[10%]">Action</div>
                    </div>
                    <div
                        ...
                        <div class="min-w-[10%] flex flex-row justify-start items-center text-xl gap-4">
